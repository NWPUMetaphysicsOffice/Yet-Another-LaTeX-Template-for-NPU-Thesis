...
% \usepackage{CJKnumb} % 除非出现中文数字编号，否则不推荐使用
% 使用默认字体
% MAYDAY! MAYDAY! 紧急使用的字体配置（使用 Adobe 字体库救急）
% \newcommand\defaultSog{Adobe Song Std}
% \newcommand\defaultHei{Adobe Heiti Std}
% \newcommand\defaultKai{Adobe Kaiti Std}
% \newcommand\defaultFag{Adobe FangSong Std}
...
% MacOS环境
\ifmacosx
    \newcommand\defaultSog{STSongti-SC-Regular}
    \newcommand\defaultHei{STHeiti}
    \newcommand\defaultKai{STKaiti}
...
\newlength{\maxlengthofappname}
\settowidth{\maxlengthofappname}{附~~~~录M}

%---------------------------------设置附录格式---------------------------------%
\let\oldappendix\appendix% Store \appendix
\newcommand{\thesisappendix}{% Update \appendix
    \oldappendix% Default \appendix
    \setcounter{chapter}{0}
    \renewcommand{\thechapter}{附录\Alph{chapter}}
    \renewcommand{\appendixname}{附录}
    \titleformat{\chapter}[hang]{\normalfont\sSanhao\filcenter\fHei\bf}{%
        \fHei\sSanhao{\thechapter}}{20pt}{\sSanhao}
    \titlecontents{chapter}[0pt]{\fSong\sRealHalfXiaosi\vspace{0.5em}}{%
        \contentsmargin{0pt}\fSong\makebox[0pt][l]{\thecontentslabel}\hspace{\maxlengthofappname}}{%
...
% 页眉设置
\fancyhead{}
\fancyhead[CEH]{西北工业大学博士学位论文}           % 默认博士版本
